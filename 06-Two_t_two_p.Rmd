...
A gamma (`r round(psi.gamma$shape, digits=1)`, `r round(psi.gamma$rate, digits=1)`) distribution can, therefore, be used to represent hyperprior information on *psi*.  
