...
In this document we have described some of the "main" LCM. More specifically we described LCMs that can be used with:  
  ...
  -**Two** conditionally **independent** diagnostic tests applied in **more than one population**  
  -**Two** conditionally **dependent** diagnostic tests applied in **more than one population**  
