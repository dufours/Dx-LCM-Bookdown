...
# We will use the same priors for prevalence of pregnancy in the three herds
...
Prev3.shapea <- Prev$shape1         #a shape parameter for Prev in population 3    
Prev3.shapeb <- Prev$shape2         #b shape parameter for Prev in population 3
