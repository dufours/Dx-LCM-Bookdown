...
######################################################
######################################################
###   PROVIDE THE DATA FOR THE 8 CELLS BELOW       ###
######################################################
######################################################

datalist <- list(n=c(#################TO COMPLETE#################))
...
#I could use vague priors for Se and Sp of TRE
...
bug.out <- jags(
  ######################################################
  ######################################################
  ###   FILL IN THE INFO FOR THE JAGS FUNCTION      ###
  ######################################################
  ######################################################  
                )   
