...
- If a substantial number of populations were studied:  
  - We could run the model after removing one of the population and repeat this process for each populations. If the results (e.g., the test's accuracy parameters) differ substantially for one of the model, this could indicate that the test accuracy is different in this population;  
