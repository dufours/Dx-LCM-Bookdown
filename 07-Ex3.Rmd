...
We have small difference between approaches. In the LCM with informative priors, we indicated, as prior knowledge, that US Se and Sp were around 0.90 and 0.95, respectively. Our posterior estimates for these parameters were 0.93 and 0.98. So, our data indicates that US Se and Sp is possibly better than what was reported by [Romano et al.](https://www.sciencedirect.com/science/article/pii/S0093691X06001543?via%3Dihub). This is confirmed in the model were we used vague priors. In that latter LCM, only the data were used to provide Se and Sp estimates, and, in that model, US Se and Sp were estimated at 0.96 and 0.99, respectively.  
